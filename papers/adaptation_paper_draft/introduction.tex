...
\changed{
	...
	%
	Secondly, select an algorithm to increase the utilization of node's resources and reduce the likelihood of \emph{broadcast storms}~\cite{BroadcastStormProblem}; i.e. presence of collisions, contentions and redundant broadcast messages.
	%
