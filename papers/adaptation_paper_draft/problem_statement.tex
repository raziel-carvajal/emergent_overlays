...
\begin{itemize}
	...
	Some metrics to measure the performance of a protocol are: power consumption of nodes' batteries, number of redundant received messages and network coverage, which is the proporsio
 or \emph{after} a forward operation take place.
