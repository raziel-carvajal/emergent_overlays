...
%
For instance, Figure~\ref{explaining-backbone} depicts a small network of nodes where $A$ starts with the message dissemination.
%
...
%
In this work, our goal is to define an experimental framework to fairly assess representative broadcast algorithms for MANETs. 
%
