...
Table~\ref{tbl:rules} summarizes our results.
%
It has the form of a set of rules that allows to choose an appropriate broadcast algorithm for a given deployment scenario.
%
...
%
For that reason, we suggest \emph{simple flooding} when the density is very low.
%
