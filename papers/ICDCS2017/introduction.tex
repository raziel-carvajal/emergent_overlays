...
\begin{itemize}
	...
	A broadcast algorithm should guarantee high coverage and cope with mobility patterns under a large variety of scenarios, where the connectivity between nodes is changing constantly.
\end{itemize}
