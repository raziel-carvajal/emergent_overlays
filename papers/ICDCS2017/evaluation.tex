...
%
The amount of received and sent messages impacts power consumption because in every message exchange the radio switch to a more power hungry mode.
%
...
%
In CSMA, a node keeps resending messages until the destination replies with an \textit{ACK} notification.
%
This strategy increases network reliability but it increments the energy consumption.
%
...
%
Also interesting is that \textit{MPR} always outperform other approaches when there is no mobility.
%
This is consistent with the results depicted in Figures~\ref{fig:a-saved} and~\ref{fig:a-duplicated}, which show that nodes send and receive fewer messages in this approach.
%
