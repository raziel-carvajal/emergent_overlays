...
%
These results confirm that mobility and the ratio $\frac{broadcast-freq}{control-message-freq}$, may impact the decision of which algorithm to use to broadcast.
%
