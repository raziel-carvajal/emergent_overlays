...
%
Given that the latter cannot maintain a completely up-to-date backbone, it fails in reducing the number of relay nodes and the power consumption increases.
%
