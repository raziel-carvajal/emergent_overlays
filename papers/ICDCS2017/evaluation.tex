...
Power consumption depends on the number of messages exchanged.
%
The amount of received and sent messages is important because every time a node sends or receives a message \deleted{, the \textit{transmitter} and/or \textit{receiver} components of} its radio changes to a more power hungry mode.
%
Thus, the broadcast messages retransmitted as well as the control messages influence the energy consumption.
%
