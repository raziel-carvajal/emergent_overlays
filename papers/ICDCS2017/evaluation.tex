...
\begin{figure*}[ht]
	...
	\subfigure[SRE messages in static scenarios.]{
		\label{fig:a-saved}
		\includegraphics[page=1, scale=0.32, trim = 20mm 7mm 0 0]{fig/results-static-summary.pdf}
	}
	~
	\subfigure[Duplicate messages per algorithm in static scenarios.]{
		\label{fig:a-duplicated}
		\includegraphics[page=3, scale=0.32, trim = 16mm 0 10mm 0]{fig/results-static.pdf}
	}
	~
	\subfigure[SRE messages in dynamic scenarios.]{
		\label{fig:b-saved}
		\includegraphics[page=1, scale=0.32, trim = 20mm 7mm 0 0]{fig/results-mobility-summary.pdf}
	}
	~
	\subfigure[Duplicate messages per algorithm in dynamic scenarios.]{
		\label{fig:b-duplicated}
		\includegraphics[page=3, scale=0.32, trim = 16mm 0 10mm 0]{fig/results-mobility.pdf}
	}
...
\begin{figure*}[ht]
	...
	\subfigure[Power consumption in static scenarios]{
		\label{fig:a-energy}
		\includegraphics[page=1, scale=0.32, trim = 16mm 0 10mm 0]{fig/results-static.pdf}
	}
	~
	...
	\subfigure[Power consumption in dynamic scenarios]{
		\label{fig:b-energy}
		\includegraphics[page=1, scale=0.32, trim = 16mm 0 10mm 0]{fig/results-mobility.pdf}
	}
