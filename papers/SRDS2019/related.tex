...
The \emph{broadcast storm} problem associated with flooding is identified by Ni et al.~\cite{BroadcastStormProblem}, who also propose \emph{controlled flooding} using counters and timers as we use in this paper.
