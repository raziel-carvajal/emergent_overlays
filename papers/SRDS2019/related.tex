...
Tseng, Ni and Shih~\cite{2001:AAR:876878.879323} similarly propose the ACF adaptation mechanism that we used in our evaluation (\S\ref{sec:evaluation}).
Controlled flooding adaptation can use measures of the nodes' velocity, as for S-H flooding detailed in \S\ref{sec:evaluation}~\cite{adaptive_group_com_iscc02}, or measures of observed contention and collisions~\cite{2001:AAR:876878.879323}.
