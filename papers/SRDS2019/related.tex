...
\textbf{Overlay-based approaches.} Wu J and Lin H propose one of the earliest distributed protocols to approximates minimum Connected Dominating Sets (CDSs).
%
Nodes only require the list of their one-hop neighbors via a periodic e
