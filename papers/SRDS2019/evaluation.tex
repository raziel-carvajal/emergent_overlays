...
\smallskip
\noindent
\textbf{Broadcast protocols.} Along with our implementation of emergent overlays, we provide individual implementations for controlled flooding~\cite{BroadcastStormProblem}, the overlay-based technique MPR~\cite{mpr}, and two adaptive approaches, controlled flooding~\cite{2001:AAR:876878.879323} as well as scoped-hyper flooding~\cite{adaptive_group_com_iscc02}.
%
