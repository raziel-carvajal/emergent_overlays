...
\protect\er{Raziel: change the XX with the proper values. What does it mean to have decimal numbers for the number of collisions, this is an average?}
}
\label{tab.conf}
\end{table}