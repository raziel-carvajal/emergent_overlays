...
As a result, there are no existing broadcast protocols that remain reliable and efficient whatever their deployment conditions. Further, nodes use either controlled flooding or overlay-based algorithms, two incompatible protocols. It leads to \textit{heterogeneous} MANETs made of non-interoperable clusters of nodes that arbitrary perfoms either good or bad according to their mobility patterns. 
