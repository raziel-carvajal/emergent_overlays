...
Second, there are points of attraction around which users tend to aggregate~\cite{stepanov2005mobility_model_outdoor,Aschenbruck2009}, leading to zones of heterogeneous \emph{density}.
...
The authors performed an estimation of the population size and of its spatial distribution by collecting unique MAC address from the significant portion of attendees' mobiles phone that were discoverable via bluetooth.
...
Broadcast protocols for MANETs aim at reliably delivering messages to all nodes despite collisions.
They can be classified in two families~\cite{ruiz2015survey}:
...
Overlay-based broadcast~\cite{Nikolov2015, stojmenovic-cds, mpr} shines when nodes are relatively stable.
It enables important saving in energy and retransmissions in densely-populated areas.
%
...
Our motivation is that controlled flooding is efficient in the general case, but that using an overlay is beneficial in zones where density increases and mobility decreases, typical of human movement at points of interest.
%
