...
MANETs allow networked applications in situations where no infrastructure is available, or where the available infrastructure does not suffice\cite{overview_adhoc_networks,Bellavista2013}.
