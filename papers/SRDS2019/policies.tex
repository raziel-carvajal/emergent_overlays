...
\section{Adaptation: observables and policies}
...
\begin{itemize}
	...
	\item used to derive:
	\begin{itemize}
		\item local density (how many nodes in range)
		\item clustering between one-hop neighbors
		\item local stability (use a figure: we probe the network regularly through existing mac-layer messages, we can keep snapshots of the neighbors, and estimate how much time we see a neighbor)
	\end{itemize}
\end{itemize}
