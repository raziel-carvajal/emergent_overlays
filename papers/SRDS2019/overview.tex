...
However, it falls short when density increases, leading to broadcast storms~\cite{BroadcastStormProblem}.
...
Human mobility models~\cite{Hess:2015:DHM:2856149.2840722,Aschenbruck2009,rhee2011levy} indicates that a hybrid approach could benefit from the resiliency and robustness of controlled flooding in general, while leveraging overlays where and when they are beneficial, that is, around the \emph{points of interests} (POI) identified at large gatherings~\cite{naini2015opportunistic,versichele2012use}.
...
% Mobility models~\cite{Hess:2015:DHM:2856149.2840722,Aschenbruck2009,rhee2011levy} and measurement campaigns at large-scale gatherings~\cite{naini2015opportunistic,versichele2012use} indicate that human users tend to aggregate around points of interest for extended periods of time.
% When around such points of interests (e.g. the concert stages at the Paléo festival in~\cite{naini2015opportunistic}), the speed of users decreases or even comes to a stop.
