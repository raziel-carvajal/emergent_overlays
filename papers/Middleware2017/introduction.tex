...
\begin{itemize}
	...
	have shown that the performance and costs of each broadcast approach was intimately linked to environmental aspects of the MANET. In particular, density and mobility are key factors. Give the intuition: the denser the network, the better it is to use an overlay to avoid collisions and speed up transmission (in less dense networks this is not as helpful and may lead to partitions if not up-to-date); and the more mobility there is, the less useful an overlay is since constructed overlays quickly become deprecated, posing risks of having partitions or bad coverage.
	...
	\item we are interested in this work in making broadcasting more efficient and less costly for heterogeneous MANETs
