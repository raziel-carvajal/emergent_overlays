...
Algorithm & \rot{\shortstack[l]{No need for\\One-hop neighbor}} & \rot{\shortstack[l]{No need for\\Two-hop neighbor}} & \rot{\shortstack[l]{No need for periodic\\control messages}} & \rot{\shortstack[l]{Piggyback\\control messages}} & \rot{Use of thresholds} & \rot{Stochastic decision} & \rot{Source-independent}  & \rot{\shortstack[l]{Allowing Switch\\Protocol}} &\rot{\shortstack[l]{Full coverage\\(>95\%)}}\\
