...
We generalize the architecture of MANET applications in three main layers.
%
...
\begin{itemize}
\item $\AlgoSend()$. This function disseminates a message in the transmission area $A_{emitter}$ of the emitter
