...
/**
 * Class generated from <tt>inet/broadcasting/BroadcastingAppBase.msg:19</tt> by nedtool.
 * <pre>
 * packet Hello
 * {
 *     string sender;
...
/**
 * Class generated from <tt>inet/broadcasting/BroadcastingAppBase.msg:25</tt> by nedtool.
 * <pre>
 * packet Broadcast
 * {
 *     string id;
...
/**
 * Class generated from <tt>inet/broadcasting/BroadcastingAppBase.msg:32</tt> by nedtool.
 * <pre>
 * packet FloodingMessage
 * {
 *     string id;
 *     string sender;
 *     string payload;
 ...
 * </pre>
 */
class INET_API FloodingMessage : public ::cPacket
{
  protected:
    opp_string id_var;
    opp_string sender_var;
