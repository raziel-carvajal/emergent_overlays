...
////
//
//#ifndef ADAPTIVETEST_H_
//#define ADAPTIVETEST_H_
//
...
//using namespace std;
//
//class AdaptiveTest : public UDPBasicApp {
//
//  protected:
//    enum Algos { FLOOD, LAST_ALGO};
//    IProtocol* algos[LAST_ALGO];
//    enum Events {
