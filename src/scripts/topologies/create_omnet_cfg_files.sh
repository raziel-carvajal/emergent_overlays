...
sed -i -e "s/CONFIGURATION_NAME/${expeId}poiscenario/" iniFile
...
mv iniFile "${expeId}poiscenario.ini"
mv "${expeId}poiscenario.ini" ../../../experiments/configs/built_configs
### job for worker
echo "${expeId}poiscenario.ini" > "../../../experiments/configs/built_configs/cfgs_for_workers"
