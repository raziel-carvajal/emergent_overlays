...
\textbf{Area based beaconless (ABB)} \cite{Ovalle-Martinez2006}

\textbf{Multipoint relaying  (MPR) } \cite{Qayyum2002}

\textbf{Computing relay points based on connected dominating sets (CDS)} \cite{Wu2001}
