...
IoT has led to a strong revival of interest in mobile ad-hoc networks (MANETs).
%
...
%
The broadcasting problem in MANET has received considerable attention.
%
...
%
These findings can be used to design a broadcasting approach that changes its behavior at runtime based on the context of a node.
%
...
%
The parameters that describe the experiments setup are discussed in Section~\ref{sec:scenarios}. 
%
