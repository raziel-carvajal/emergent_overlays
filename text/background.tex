...
%
The marking procedure simply identifies whether one node $n$ has any pair of neighbors that are unconnected, $n$ marks itself as a relay node if this condition takes place.
%
...
%
One can refer to~\cite{Wu2001} for having more details about these two rules.
