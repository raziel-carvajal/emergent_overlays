...
\subsection{Coping with underlying topologies}
...
%
As in MPR, data about one-hope and two-hop neighbors is required as well. 
%
The marking procedure simply identifies whether one node $n$ has any pair of neighbors that are unconnected, $n$ marks itself as a relay node if the later condition occurs.
%
