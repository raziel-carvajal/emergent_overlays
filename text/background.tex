...
%
Any other node out of the backbone act as message receiver.
%
...
%
We consider two topology-based algorithms: \textit{MPR} and \textit{node-degree}.
\begin{figure*}[t]
	\centering
	\subfigure[Transmission range with omnidirectional antennas]{\label{fig:explaining-backbone:a}\includegraphics[width=0.4\textwidth]{fig/explainingbackbone_b.pdf}}
	~
