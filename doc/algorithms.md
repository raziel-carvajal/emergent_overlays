...
| Area-based beaconless reliable broadcasting in sensor networks ([abba](papers/implemented/abba.pdf))  | Journal  | International Journal of Sensor Networks  |  | 2006  | No |
